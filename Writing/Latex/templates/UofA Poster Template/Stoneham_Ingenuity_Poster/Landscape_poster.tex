...
\usepackage{titlesec}
\titleformat{\section}
{\fontfamily{ptm}\selectfont \huge} % Like Georgia
{\thesection}{1em}{}  
...
% The header is divided into three minipage boxes:
% The widths of these boxes can be easily edited to accommodate your content as you see fit
% Do not manipulate the UofA logo 

\begin{minipage}[b]{0.2\linewidth}
\includegraphics[width=0.75\linewidth]{figures/UofA_logos.pdf} \\
\end{minipage}
\hfill
\begin{minipage}[b]{0.45\linewidth}
\fontfamily{ptm}\selectfont\veryHuge \color{NavyBlue} \textbf{Complicated Research Title} \color{Black}\\[+2mm] % Title
{\fontfamily{ptm}\selectfont \Huge An Exploration of Complexity}\\[+8mm] % Subtitle in a different font
\huge \textbf{Leonhard Euler  \& Pierre Simon-Laplace}\\[+2mm] % Author(s)
\huge University of Adelaide/School of Mathematical Science\\ % University/organization
\end{minipage}
%
\begin{minipage}[b]{0.25\linewidth}
\color{DarkSlateGray}\Large \textbf{Contact Information:}\\
School of Mathematical Sciences\\ % Address
Adelaide University \\
North Terrace, Adelaide\\ \\
Phone: +61 (8)  8313 4148\\ % Phone number
Email: \texttt{le.psl@adelaide.edu.au}\\ % Email address
\end{minipage}
...
\includegraphics[width=0.8\linewidth]{A1F_AreaElement.pdf}
...
\end{minipage}
\vfill
% This footer must remain at the base of the poster
\includegraphics[width=\linewidth]{figures/1650-9_A0_Poster_Temp_Portrait_313.pdf} 
