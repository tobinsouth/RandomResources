...
\usepackage{titlesec}
\titleformat{\section}
  {\fontfamily{ptm}\selectfont \huge}
  {\thesection}{1em}{}  
...
\includegraphics[width=0.9\linewidth]{figures/UofA_logos.pdf}
\end{minipage}
\hfill
\begin{minipage}[b]{0.7\linewidth}
\fontfamily{ptm}\selectfont \veryHuge \color{NavyBlue} Complicated Research Title \color{Black}\\[+2mm] % Title
\Huge An Exploration of Complexity \\[+8mm] % Subtitle in a different font
\huge \textbf{Leonhard Euler  \& Pierre Simon-Laplace}\\[+2mm] % Author(s)
\huge University of Adelaide/School of Mathematical Science\\[+8mm] % University/organization
\Large Email: \texttt{le.psl@adelaide.edu.au} \qquad Phone: +61 (8)  8313 4148\\
\end{minipage}
...
\includegraphics[width=0.6\linewidth]{figures/A1F_AreaElement.pdf}
...
\includegraphics[width=\linewidth]{figures/1650-9_A0_Poster_Temp_Portrait_v2.pdf} \\
\end{document}